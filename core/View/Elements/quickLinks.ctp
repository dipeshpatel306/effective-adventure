...
<ul>
	...
	<?php if($acct == 'Subscription' && $group == 2): ?>
		...
		<li><?php echo $this->Html->link('Policies & Procedures', array('controller' => 'policies_and_procedures', 'action' => 'index')); ?></li>
		<li><?php echo $this->Html->link('Risk Assessment Documents', array('controller' => 'risk_assessment_documents', 'action' => 'index')); ?></li>
		<li><?php echo $this->Html->link('Security Training', array('controller' => 'education_center', 'action' => 'training')); ?></li>
