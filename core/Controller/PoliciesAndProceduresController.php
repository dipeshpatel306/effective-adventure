 ...
 */
	...
	//	if($group == 1 || $group == 2 ){
			$documents = $this->PoliciesAndProcedure->PoliciesAndProceduresDocument->find('all', array(
				...
				'PoliciesAndProceduresDocument.attachment', 'PoliciesAndProceduresDocument.attachment_dir', 'PoliciesAndProceduresDocument.created', 'PoliciesAndProceduresDocument.modified')	
