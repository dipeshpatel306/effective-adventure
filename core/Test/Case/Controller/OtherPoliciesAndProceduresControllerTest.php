<?php
App::uses('OtherPoliciesAndProceduresController', 'Controller');

/**
 * OtherPoliciesAndProceduresController Test Case
 *
 */
class OtherPoliciesAndProceduresControllerTest extends ControllerTestCase {
