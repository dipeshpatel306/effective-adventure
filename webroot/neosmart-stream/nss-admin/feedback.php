...
?>
	...
	<h2 id="marker-config">Feedback</h2>
	...
	<div class="nss-admin-container warning">
		...
		<div class="todo"><a href="https://neosmart-stream.de/get-a-license/" target="_blank"><b>Update to Pro Version</b></a> to use all feedback features.</div>
	</div>
	<?php } ?>
