<?php
App::uses('PoliciesAndProceduresController', 'Controller');

/**
 * PoliciesAndProceduresController Test Case
 *
 */
class PoliciesAndProceduresControllerTest extends ControllerTestCase {
