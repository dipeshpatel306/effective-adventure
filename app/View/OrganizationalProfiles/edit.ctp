<?php
	...
	$os_installed = explode(',', $this->request->data['OrganizationalProfile']['os_installed']);
?>

<div class="organizationalProfiles form">
<?php echo $this->Form->create('OrganizationalProfile'); ?>
	<fieldset>
		<legend><?php echo __('Edit Organizational Profile'); ?></legend>
	<?php
		...
		echo $this->Form->input('state', array('label' => 'State: ', 'options' => $states, 'empty' => 'Select One'));
		...
		echo $this->Form->input('second_location', array('label' =>'Do you have a second location?', 'options' => $choice, 'empty' => 'Select One'));
		...
		echo $this->Form->input('emr_ehr_implemented', array('label' => 'Do you have an EMR/EHR implemented?', 'options' => $choice, 'empty' => 'Select One' ));
		...
		echo $this->Form->input('email', array('label' => 'Do you utilize Email in your organization?', 'options' => $choice, 'empty' => 'Select One'));
		echo $this->Form->input('email_vendor', array('label' => 'What Email vendor and product do you use?', 
														'options' => $emailVendor, 'empty' => 'Select One'));
		echo $this->Form->input('email_vendor_details', array('label' => 'List the name of the other Email vendor or provide more details: '));		
		echo $this->Form->input('email_server_location', array('label' => 'Where is your Email Server?', 'options' => $emailHost, 'empty' => 'Select One'));
		...
		echo $this->Form->input('portable_media_devices', array('label' => 'Do you use portable media devices?', 
																'options' => $choice, 'empty' => 'Select One'));
		echo $this->Form->input('tablets', array('label' => 'Do you use Tablets?', 'options' => $choice, 'empty' => 'Select One'));
		echo $this->Form->input('list_portable_devices', array('label' => 'List the portable media devices you are currently using:'));
		echo $this->Form->input('back_up_tapes', array('label' => 'Do you utilize backup tapes?', 'options' => $choice, 'empty' => 'Select One'));
		
		echo $this->Form->input('smartphones', array('label' => 'Do you utilize smartphones?', 'options' => $choice, 'empty' => 'Select One'));
		...
		echo $this->Form->input('system_1_os', array('label' => 'System 1 Operating System: ', 'options' => $os, 'empty' => 'Select One'));
		echo $this->Form->input('system_1_vendor', array('label' => 'System 1 Vendor: '));
		echo $this->Form->input('system_1_location', array('label' => 'System 1 Location: ', 'options' => $host, 'empty' => 'Select One'));
		...
		echo $this->Form->input('system_2_os', array('label' => 'System 2 Operating System: ', 'options' => $os, 'empty' => 'Select One'));
		echo $this->Form->input('system_2_vendor', array('label' => 'System 2 Vendor: '));
		echo $this->Form->input('system_2_location', array('label' => 'System 2 Location: ', 'options' => $host, 'empty' => 'Select One'));
		...
		echo $this->Form->input('system_3_os', array('label' => 'System 3 Operating System: ', 'options' => $os, 'empty' => 'Select One'));
		echo $this->Form->input('system_3_vendor', array('label' => 'System 3 Vendor: '));
		echo $this->Form->input('system_3_location', array('label' => 'System 3 Location: ', 'options' => $host, 'empty' => 'Select One'));
		...
		echo $this->Form->input('system_4_os', array('label' => 'System 4 Operating System: ', 'options' => $os, 'empty' => 'Select One'));
		echo $this->Form->input('system_4_vendor', array('label' => 'System 4 Vendor: '));
		echo $this->Form->input('system_4_location', array('label' => 'System 4 Location: ', 'options' => $host, 'empty' => 'Select One'));
		...
		echo $this->Form->input('system_5_os', array('label' => 'System 5 Operating System: ', 'options' => $os, 'empty' => 'Select One'));
		echo $this->Form->input('system_5_vendor', array('label' => 'System 5 Vendor: '));
		echo $this->Form->input('system_5_location', array('label' => 'System 5 Location: ', 'options' => $host, 'empty' => 'Select One'));
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('OrganizationalProfile.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('OrganizationalProfile.id'))); ?></li>
