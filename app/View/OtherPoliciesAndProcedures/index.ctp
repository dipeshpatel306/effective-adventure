...
<div class="otherPoliciesAndProcedures index">
	...
	<tr>
		...
		<td>
		<?php 
			//$attachment = $otherPoliciesAndProcedure['OtherPoliciesAndProcedure']['attachment'];
		
			echo preg_replace('/\/.*\//', '', $otherPoliciesAndProcedure['OtherPoliciesAndProcedure']['attachment']);
		?>
		</td>
