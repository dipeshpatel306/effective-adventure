 ...
 ************************************************************************/
$out .= <<<EOD
	<div id="nss-item-$position" data-id="$id" class="nss-item nss-$channel $item_class">
		<div class="nss-head">
...
switch($extras_facebook_type){
	case 'photo':
		$out .= "<a class='nss-facebook-photo' href='$extras_facebook_link' target='_blank'><img class='nss-facebook-picture' src='$extras_facebook_image_720' alt='' border='0'></a>";
	...
	case 'link':
		...
		$out .= "<a class='nss-facebook-name' href='$extras_facebook_link' target='_blank'>$extras_facebook_name</a>";
		$out .= "<div class='nss-facebook-description'>$extras_facebook_description</div>";
		if($extras_facebook_image_720){
			$out .= "<a class='nss-facebook-photo' href=\"$extras_facebook_link\" target='_blank'><img class='nss-facebook-picture' src='$extras_facebook_image_720' alt=\"$extras_facebook_link\" border='0'></a>";
		}
		$out .= "</div>";
	break;
	case 'status':
